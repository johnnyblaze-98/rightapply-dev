...
export default {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // Sunlight Orange theme for RightApply.ai
        orange: {
          25: '#fffbf5',
          50: '#fff7ed',
          100: '#ffedd5',
      ...
      boxShadow: {
        'orange': '0 10px 25px rgba(249, 115, 22, 0.15)',
        'orange-lg': '0 20px 40px rgba(249, 115, 22, 0.15)',
        'orange-xl': '0 25px 50px rgba(249, 115, 22, 0.15)',
      },
      backdropBlur: {
        'xs': '2px',
      },
